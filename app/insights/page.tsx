      ...
      <div className="container-x">
        ...
        <div className="max-w-3xl mb-16 space-y-4">
          ...
          <h1 className="font-display font-semibold text-4xl sm:text-6xl text-black leading-tight tracking-tight">
            Insights on <span className="text-[#ff4500] font-bold">digital growth.</span>
          </h1>
          <p className="text-neutral-600 text-sm md:text-base leading-relaxed">
            Notes on brand, growth, engineering, and building digital systems that perform for real businesses.
          </p>
        </div>
