          ...
          >
            <h1 className="font-display text-black leading-tight mb-8">
              <span className="font-display block text-3xl sm:text-5xl md:text-6xl lg:text-[62px] font-semibold leading-tight mb-2">
                Performance Marketing & Digital Growth Studio
              </span>
              <span className="font-display block text-2xl sm:text-4xl md:text-5xl lg:text-[46px] leading-tight text-neutral-800">
                Turn search intent into <span className="text-[#ff4500] font-bold">leads, customers & sales.</span>
              </span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed mb-10 font-normal">
              ConversionHouse builds performance marketing campaigns, high-converting websites, Meta Ads, Google Ads, and custom growth systems designed for measurable return on ad spend.
            </p>
        ...
        <div className="container-x">
          <ScrollReveal className="mb-12 sm:mb-16 text-left max-w-4xl space-y-4">
            ...
            <h2 className="font-display text-4xl sm:text-6xl lg:text-7xl font-semibold text-black leading-[1.02]">
              Performance marketing services built for <span className="text-[#ff4500] font-bold">predictable return.</span>
            </h2>
            <p className="text-neutral-500 text-sm md:text-base max-w-xl leading-relaxed pt-1">
              We connect paid ad campaigns, search engine optimization, high-converting landing pages, and analytics into one unified growth engine.
            </p>
          </ScrollReveal>
                  ...
                  >
                    {s.images.map((imgSrc, imgIdx) => (
                      ...
                      >
                        <img
                          src={imgSrc}
                          alt="ConversionHouse Service Portfolio Mockup"
        ...
        <div className="container-x">
          <ScrollReveal className="flex flex-col md:flex-row md:items-end justify-between mb-10 sm:mb-12 gap-6">
            <div className="space-y-3">
              <span className="text-[#ff4500] text-xs font-mono uppercase tracking-widest">[ Shipped Projects & Proof ]</span>
              ...
              <p className="text-neutral-500 text-sm max-w-md">
                A selection of work across Meta Ads, web design, SEO, and Shopify e-commerce. Every project solves a commercial growth goal.
              </p>
            </div>
            <Link
              href="/work"
        ...
        <div className="container-x">
          <ScrollReveal className="mb-10 max-w-xl">
            ...
            <p className="text-neutral-500 text-sm mt-3 leading-relaxed">
              The work isn't finished when the website goes live. A successful performance campaign creates measurable growth: More visibility, qualified leads, customer acquisitions, and sales.
            </p>
          </ScrollReveal>
      ...
      <section className="py-16 sm:py-20 border-t border-neutral-100 bg-white">
        <ScrollReveal className="container-x text-center max-w-xl mx-auto space-y-5">
          ...
          <p className="text-neutral-500 text-sm">
            Select your scope. Calculate an estimated investment for Meta Ads, Google Ads, web development, or CRO.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <ScrollReveal className="lg:col-span-6 space-y-5">
              ...
              <p className="text-neutral-500 leading-relaxed text-sm">
                ConversionHouse exists to close the gap between looking good online and performing well online. We bring together performance marketing, web technology and conversion engineering to help businesses acquire qualified leads and grow revenue.
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.15} className="lg:col-span-6 bg-white border border-neutral-100 p-8 rounded-2xl relative overflow-hidden shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-xs text-neutral-500 font-mono">
                  <p>• Strategy informs performance ad design.</p>
                  <p>• User experience supports customer conversion.</p>
                  <p>• Technology enables speed & tracking.</p>
                  <p>• Paid media creates predictable demand.</p>
                  <p>• Data tells us what to optimize next.</p>
                </div>
              </div>
            </ScrollReveal>
          </div>
      ...
      <section className="py-24 border-t border-neutral-100 bg-white relative overflow-hidden">
        <ScrollReveal className="container-x relative z-10 text-center max-w-3xl space-y-6">
          ...
          <p className="text-neutral-500 text-sm max-w-lg mx-auto leading-relaxed">
            Whether you're building a brand from scratch, scaling Meta Ads & Google Ads, launching an e-commerce store, or optimizing lead conversion — let's figure out what you actually need.
          </p>
